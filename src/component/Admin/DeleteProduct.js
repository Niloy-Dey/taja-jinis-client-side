    ...
    return (
        <div> <div className='text-center mt-20 flex justify-center items-center'>
                    ...
                    product.map(tool =>
                        <div className='card-style my-5  ' key={tool.id}>
                            <div className='flex justify-around	 w-90 shadow-lg rounded-lg p-10 '>
                                ...
                                <h5 className='ml-2'><button onClick={() => handleDelete(tool._id)} className="delete-button  bg-green-400  p-2 rounded-lg text-white "> Delete </button></h5></div>
                        </div>)
                }
            ...
            <div className='text-center  '>
                <Link to={`/dashboard/addProduct`}> <button className="btn bg-green-400">Add New Item</button> </Link>
            </div></div>
    );
};
